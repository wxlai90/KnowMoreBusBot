...
class BusBot(TBot):
	...
	def processTextMessage(self):
		currentUpdate = self.currentUpdate
		...
		TextUpdate.Chat_first_name = currentUpdate['message']['chat']['first_name']
	...
	def processCallbackQuery(self):
		...
		CallBackUpdate.From_first_name = currentUpdate['callback_query']['message']['from']['first_name']
		...
		CallBackUpdate.Chat_first_name = currentUpdate['callback_query']['message']['chat']['first_name']
